...
func (_m *MockRepository) FindAllAds() (Ad.Ads, error) {
	ret := _m.Called()

	var r0 Ad.Ads
	var r1 error
	if rf, ok := ret.Get(0).(func() (Ad.Ads, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() Ad.Ads); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Ad.Ads)
...
func (_c *MockRepository_FindAllAds_Call) Return(_a0 Ad.Ads, _a1 error) *MockRepository_FindAllAds_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_FindAllAds_Call) RunAndReturn(run func() (Ad.Ads, error)) *MockRepository_FindAllAds_Call {
	_c.Call.Return(run)
	return _c
}
